...
phase = 0
spat_freq = 0.04
decoder = lda_two_class
str_decoder = 'lda_two_class'
...
plt.savefig('/home/guido/Projects/AllenBrainDecoding/Plots/StaticGratings/' + str_decoder + '/GreedyDecoding_' + area[0])
plt.show()
