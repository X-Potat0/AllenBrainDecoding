...
np.save(root_path + 'boc/ophys_decoding_results/' + str_decoder + '_' + area[0], decode_perf)
...
#plt.savefig('/home/guido/Projects/AllenBrainDecoding/Plots/' + str_decoder + '/SampleSizeDecodingAllNeurons_' + area[0])
